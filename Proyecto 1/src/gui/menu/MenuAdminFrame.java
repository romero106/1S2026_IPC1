...
import gui.usuarios.operadores.GestionOperadoresFrame;
...
public class MenuAdminFrame extends JFrame {
    ...
    JButton btnGestionarOperadores;
    ...
    JPanel panel;
    // CONSTRUCTOR
    public MenuAdminFrame(SistemaBiblioteca sistema, Usuario usuario) {
        ...
        btnGestionarOperadores = new JButton("Gestionar operadores");
        btnGestionarOperadores.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                new GestionOperadoresFrame(sistema).setVisible(true);
            }
        });
        ...
        btnReporteBitacora.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if(generado) {
                    JOptionPane.showMessageDialog(null, "Reporte de bitácora generado correctamente en Proyecto1/reportes");
        ...
        panel.add(btnGestionarOperadores);
